...
export default function DAOPage() {
  ...
  return (
    <div className="mt-2 w-full">
      ...
      <div className="flex flex-col gap-3 items-center border rounded-xl mt-2 w-full min-h-screen py-2">

        <div className="flex py-1 items-center justify-center gap-6">
          <Image className="rounded-t-lg" src={info?.logo} alt="" height={96} width={96} />
          <p className="text-2xl font-bold">{info?.name}</p>
        </div>
        <div className="flex flex-col gap-2 items-center w-full border-y py-3">
